...
<div class="contenedor">
	...
	<div class="card2">
		...
		<h4>Misión</h4>
		<p>Velar por el bienestar animal del corregimiento, sensibilizando a la comunidad sobre el cuidado de la población canina y felina.</p>
	</div>
	
	<div class="card2">
		<img src="publico/images/f5.jpg">
		<h4>Visión</h4>
		<p>Consolidarnos como una fundación de carácter social, ambiental y educativa en el corregimiento de San Cristóbal.</p>
	</div>
	
	<div class="card2">
		<img src="publico/images/f4.jpg">
		<h4>Objetivos</h4>
		<p>Buscar estrategias educativas y sociales que concienticen a la población en general sobre el trato y bienestar animal.</p>
	</div>
</div>
